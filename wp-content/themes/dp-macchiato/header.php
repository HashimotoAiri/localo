...
// **********************************
echo '<script>var j$=jQuery;paceOptions={restartOnRequestAfter:false};'.$wow_js.$plx_js.'</script>';
// **********************************
// js for slideshow
// **********************************
echo make_slider_js();
// **********************************
// js for fullscreen video
// **********************************
echo make_fullscreen_video_js();
// **********************************
// Autopager JS
// **********************************
...
?>
<div id="container" class="dp-container clearfix<?php echo $cur_page_class.$show_header_class; ?>">
<?php
// **********************************
...
if (!is_home()) :
	...
	if ((bool)$hd_title_show) {
		echo '<section class="ct-hd'.$cat_color.$page_class.'">'.$plx_bg_code.$hd_title_code.$page_desc.'</section>';
	}
endif;
// **********************************
// Container widget
