...
class Yoast_GA_Admin extends Yoast_GA_Options {
	...
	public function content_head() {
		require '../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/admin/views/content_head.php';
	}
	...
	public function content_footer() {
		...
		require '../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/admin/views/content-footer.php';
