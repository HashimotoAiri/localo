...
<div class="yoast-ga-banners">
	...
	<p><a href="<?php echo $item['../../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/admin/views/url']; ?>" target="_blank">
			<img src="<?php echo $item['../../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/admin/views/banner']; ?>" alt="<?php echo $item['title']; ?>" class="yoast-banner" border="0" width="250" />
	</a></p>
	<?php endforeach; ?>
