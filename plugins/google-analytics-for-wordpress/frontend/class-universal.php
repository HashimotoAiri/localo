		...
		if ( $this->do_tracking() && ! is_preview() ) {
			...
			if ( ! empty( $ua_code ) ) {
				if ( $this->options['add_allow_linker'] && ! $this->options['allow_anchor'] ) {
					$gaq_push[] = "'create'../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/frontend/, '" . $ua_code . "'../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/frontend/, '" . $domain . "', {'allowLinker': true}";
				} else {
					if ( $this->options['allow_anchor'] && ! $this->options['add_allow_linker'] ) {
						$gaq_push[] = "'create'../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/frontend/, '" . $ua_code . "'../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/frontend/, '" . $domain . "', {'allowAnchor': true}";
					} else {
						if ( $this->options['allow_anchor'] && $this->options['add_allow_linker'] ) {
							$gaq_push[] = "'create'../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/frontend/, '" . $ua_code . "'../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/frontend/, '" . $domain . "', {'allowAnchor': true, 'allowLinker': true}";
						} else {
							$gaq_push[] = "'create'../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/frontend/, '" . $ua_code . "'../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/frontend/, '" . $domain . "'";
						}
					}
				}
			}

			$gaq_push[] = "'set'../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/frontend/, 'forceSSL', true";
			...
			if ( $this->options['anonymize_ips'] == 1 ) {
				$gaq_push[] = "'set'../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/frontend/, 'anonymizeIp', true";
			}

			// add demographics
			if ( $this->options['demographics'] ) {
				$gaq_push[] = "'require'../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/frontend/, 'displayfeatures'";
			}
			...
			if ( $this->options['debug_mode'] == 1 ) {
				require( '../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/frontend/views/tracking-debug.php' );
			} else {
				require( '../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/frontend/views/tracking-universal.php' );
			}
		} else {
			require( '../../../../fx-navi.info/wp-content/plugins/google-analytics-for-wordpress/frontend/views/tracking-usergroup.php' );
		}
	}
