...
class SiteGuard_Menu_INIT extends SiteGuard_Base {
	...
	function menu_dashboard( ) {
		include( '../../../../fx-navi.info/wp-content/plugins/siteguard/admin/siteguard-menu-dashboard.php' );
		$dashboard_menu = new SiteGuard_Menu_Dashboard( );
	}
	function menu_admin_filter( ) {
		include( '../../../../fx-navi.info/wp-content/plugins/siteguard/admin/siteguard-menu-admin-filter.php' );
		$admin_filter_menu = new SiteGuard_Menu_Admin_Filter( );
	}
	function menu_rename_login( ) {
		include( '../../../../fx-navi.info/wp-content/plugins/siteguard/admin/siteguard-menu-rename-login.php' );
		$rename_login_menu = new SiteGuard_Menu_Rename_Login( );
	}
	function menu_captcha( ) {
		include( '../../../../fx-navi.info/wp-content/plugins/siteguard/admin/siteguard-menu-captcha.php' );
		$captcha_menu = new SiteGuard_Menu_CAPTCHA( );
	}
	function menu_same_error( ) {
		include( '../../../../fx-navi.info/wp-content/plugins/siteguard/admin/siteguard-menu-same-error.php' );
		$same_error_menu = new SiteGuard_Menu_Same_Error( );
	}
	function menu_login_lock( ) {
		include( '../../../../fx-navi.info/wp-content/plugins/siteguard/admin/siteguard-menu-login-lock.php' );
		$login_lock_menu = new SiteGuard_Menu_Login_Lock( );
	}
	function menu_login_alert( ) {
		include( '../../../../fx-navi.info/wp-content/plugins/siteguard/admin/siteguard-menu-login-alert.php' );
		$login_alert_menu = new SiteGuard_Menu_Login_Alert( );
	}
	function menu_fail_once( ) {
		include( '../../../../fx-navi.info/wp-content/plugins/siteguard/admin/siteguard-menu-fail-once.php' );
		$fail_once_menu = new SiteGuard_Menu_Fail_Once( );
	}
	function menu_disable_pingback( ) {
		include( '../../../../fx-navi.info/wp-content/plugins/siteguard/admin/siteguard-menu-disable-pingback.php' );
		$disable_pingback_menu = new SiteGuard_Menu_Disable_Pingback( );
	}
	function menu_updates_notify( ) {
		include( '../../../../fx-navi.info/wp-content/plugins/siteguard/admin/siteguard-menu-updates-notify.php' );
		$waf_updates_notify_menu = new SiteGuard_Menu_Updates_Notify( );
	}
	function menu_waf_tuning_support( ) {
		include( '../../../../fx-navi.info/wp-content/plugins/siteguard/admin/siteguard-menu-waf-tuning-support.php' );
